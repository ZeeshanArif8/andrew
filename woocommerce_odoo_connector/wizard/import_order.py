...
class ImportWoocommerceOrders(models.TransientModel):
    ...
    def import_now(self, **kwargs):
        ...
        if order_id:
            order = woocommerce.get(f'orders/{order_id}').json()
            if "message" in order:
    ...
    def get_woocommerce_discount_lines(self,woocommerce,data):
        ...
        vals = {
            ...
            "line_taxes" : self.process_taxes(woocommerce, tax_ids)
        }
        return vals
    ...
    def get_woocommerce_order_line(self, woocommerce, channel, data):
        ...
        for line in line_items:
            ...
            order_line_dict = {
                ...
                'line_taxes': self.process_taxes(woocommerce,line.get("taxes"))
            }
    ...
    def _get_woocommerce_shipping(self, woocommerce, shipping_line):
        ...
        for shipping in shipping_line:
            shipping_dict = {
                ...
                'line_taxes':self.process_taxes(woocommerce,shipping.get("taxes"))
            }
    ...
    def process_taxes(self, woocommerce, taxes):
        tax_data = []
        for tax in taxes:
